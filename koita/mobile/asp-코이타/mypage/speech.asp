...
<div class="container-fluid" id="speech">
  <!-- content -->
    ...
    <textarea name="Qna_Note" id="Qna_Note" class="form-control" rows="10" required="required" placeholder="성함, 소속, 직급을 반드시 작성해주세요."><%=Qna_Note%></textarea>
