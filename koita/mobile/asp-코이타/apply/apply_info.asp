...
<div class="container">
    ...
    <section>
        <dl class="apply_info">
            ...
            <dd class="text-center apply_btn" style="display:block; width:100%;"><a style="width:100%;" class="btn btn-primary btn-lg" href="javascript:alert('참가신청이 마감되었습니다. 성원에 감사드립니다. \n(대기접수를 희망하시는 분은 사무국으로 연락 주시기 바랍니다. \n.Tel: 02-6959-3205)')" role="button">참가신청 바로 가기<i class="next glyphicon glyphicon-menu-right"></i></a></dd>
        </dl>
    </section>
    <!-- 단락 -->
    <div class="first-tap">
