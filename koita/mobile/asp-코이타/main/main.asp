<!--#include virtual="/mobile/html/inc/config.asp"-->
  <%
  TOTAL_A11_sql = "SELECT * FROM  RegData  where Reg_Type= 'Y' "
			Set TOTAL_A11_rs = server.createObject("ADODB.Recordset")
			TOTAL_A11_rs.open TOTAL_A11_sql,DBConn,1
...
<div class="container-fluid bg">
    <section class="main">
        ...
        <div class="text_box">
            ...
            <p style="">
                <span>참가신청이 마감되었습니다.성원에 감사드립니다.</span>
            </p>
        </div>
        <div class="main_btns">
        ...
        <div class="main_btns" style="bottom:3%;">
            <a class="btn btn-primary" href="/mobile/html/mypage/speech.asp" role="button">연사에게 질문하기<i class="flaticon-arrows-3"></i></a>
        </div>
    </section>
